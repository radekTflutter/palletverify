...
if(isset($_POST['input'])){
          ...
          <table>
               ...
               <tbody>
                    ...
                    while($row = mysqli_fetch_assoc($result)){
                         ...
                         $palletenumbers;
                         $orderclosedate = $row['orderclosedate'];
                         $ordereditdate = $row['ordereditdate'];
                         ...
                         <tr>
                              <td><a <?php echo $id; ?>><?php echo $id; ?></a></td>
                              <td><?php echo $code; ?> </td>
                              ...
                              <td><?php echo $orderclosedate; ?> </td>
                              <td><?php echo $ordereditdate; ?> </td>
     ...
     $input = $_POST['input'];
     echo"<h5 style='height:40px;margin-top:8%;margin-left:20%;font-size:20px;'>Wprowdź numer zlecenia w polu wszukaj</h5>";
     ?>
